            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="float-right mt-1">
                        <i class="livicon icon3" data-name="pen" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Transferer 
                    </div>
                </div>
            </div>
        </div>
            ...
            $("#mail_compose").bootstrapValidator({
                ...
                fields: {
                    email_message: {
                        validators: {
                            callback: {
                                message: 'Ce contenu ne peut pas etre vide',
                    ...
                    subject: {
                        validators: {
                            notEmpty: {
                                message: 'Le sujet est requi et ne peut pas etre vide'
                            }
                        },
                        minlength: 20
                    }
