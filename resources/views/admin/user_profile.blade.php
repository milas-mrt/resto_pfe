                                        ...
                                        <div class="activity">
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('img/authors/avatar.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle img-fluid mr-3" src="{{ asset('img/authors/avatar1.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="{{ asset('img/authors/avatar2.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('img/authors/avatar3.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('img/authors/avatar4.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    ...
                                                    <ul class="uploadphoto-list">
                                                        <li>
                                                            <a href="{{ asset('img/authors/avatar2.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('img/authors/avatar2.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('img/authors/avatar3.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('img/authors/avatar3.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ asset('img/authors/avatar.jpg') }}" data-rel="prettyPhoto">
                                                                <img src="{{ asset('img/authors/avatar.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('img/authors/avatar7.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                            ...
                                            <div class="imgs-profile media">
                                                <a class="float-left" href="#">
                                                    <img class="media-object rounded-circle mr-3" src="{{ asset('img/authors/avatar2.jpg') }}" alt=""></a>
                                                <div class="media-body">
                                                    <strong>Lenny</strong>
                                                    posted a new note.
                                                    <br>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="media blog-media">
                                                        <a class="float-left" href="#">
                                                            <img class="media-object thumbnail mr-3" src="{{ asset('img/authors/avatar4.jpg') }}" alt=""></a>
                                            ...
                                            <div class="imgs-profile media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="mb20"></div>
                                                    <a href="{{ asset('img/authors/avatar.jpg') }}" data-rel="prettyPhoto" class="img-single">
                                                        <img src="{{ asset('img/authors/avatar.jpg') }}" class="thumbnail img-fluid" alt=""></a>
                                                </div>
                                            </div>
                                            <!-- media -->
