...
<table class="table table-striped table-bordered" id="menus-table" width="100%">
    ...
    @foreach($menus as $menu)
        <tr>
            ...
            <td>{!! $menu->entrees !!}</td>
            <td>{!! $menu->plats_principaux !!}</td>
            <td>{!! $menu->boissons !!}</td>
            <td>{!! $menu->desserts !!}</td>
            <td>
                 <a href="{{ route('admin.menu.menus.show', collect($menu)->first() ) }}">
                     <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view menu"></i>
                 </a>
                 <a href="{{ route('admin.menu.menus.edit', collect($menu)->first() ) }}">
                     <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit menu"></i>
                 </a>
                 <a href="{{ route('admin.menu.menus.confirm-delete', collect($menu)->first() ) }}" data-toggle="modal" data-target="#delete_confirm" data-id="{{ route('admin.menu.menus.delete', collect($menu)->first() ) }}">
