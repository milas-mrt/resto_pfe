                                        ...
                                        <th colspan="4">
                                            <div class="row">
                                                <div class="col-md-7 col-lg-9 col-12">
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-secondary btn-toolbar" data-toggle="tooltip" data-placement="top" title="Inbox">
                                                            <i class="livicon" data-n="message-in" data-c="#418bca" data-s="28"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-secondary btn-toolbar" data-toggle="tooltip" data-placement="top" title="Delete Message">
                                                            <i class="livicon" data-n="message-remove" data-c="#f56954" data-s="28"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-secondary btn-toolbar" data-toggle="tooltip" data-placement="top" title="Flag">
                                                            <i class="livicon" data-n="message-flag" data-c="#01BC8C" data-s="28"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-secondary  btn-toolbar" data-toggle="tooltip" data-placement="top" title="Reload">
